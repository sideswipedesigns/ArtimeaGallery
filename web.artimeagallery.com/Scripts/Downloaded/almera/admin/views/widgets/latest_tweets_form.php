...
<p>
    <label for="<?php echo $widget->get_field_id('twitter_id'); ?>"><?php _e('Twitter Widget ID', 'almera') ?>:</label>
...
<p>
    <label for="<?php echo $widget->get_field_id('postcount'); ?>"><?php _e('Number of tweets', 'almera') ?>:</label>
