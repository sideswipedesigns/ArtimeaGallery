...
<p>
    <label for="<?php echo $widget->get_field_id('category'); ?>"><?php _e('Posts Category', 'almera') ?>:</label>
	<?php
	$args = array(
		'hide_empty' => 0,
		'show_option_all' => __('All Categories', 'almera'),
		'echo' => 0,
...
<p>
    ...
    <label for="<?php echo $widget->get_field_id('show_thumbnail'); ?>"><?php _e('Display Thumbnail', 'almera') ?>:</label>
</p>
...
<p>
    ...
    <label for="<?php echo $widget->get_field_id('show_exerpt'); ?>"><?php _e('Display Excerpt', 'almera') ?></label>
</p>


<p>
    <label for="<?php echo $widget->get_field_id('exerpt_symbols_count'); ?>"><?php _e('Excerpt symbols count', 'almera') ?>:</label>
...
<p>
    ...
    <label for="<?php echo $widget->get_field_id('show_see_all_button'); ?>"><?php _e('Display "View all" button', 'almera') ?></label>
</p>
