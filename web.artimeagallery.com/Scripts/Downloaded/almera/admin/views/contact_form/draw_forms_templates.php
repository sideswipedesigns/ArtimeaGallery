...
<div style="display: none;" id="contact_form_template">
	...
	<div class="form-holder">
		...
		<div class="switch">
			...
			<label for="form-captcha"><span></span><?php _e('Enable Captcha', 'almera'); ?></label>
		...
		<div class="admin-drag-holder clearfix">
			...
			<h4><?php _e('Select submit button', 'almera'); ?></h4>
			<div class="contact_form_submit_button">
				...
				TMM_OptionsHelper::draw_theme_option(array(
					...
					'value' => '',
					'css_class' => '',
					'description' => __('Select Submit Button\'s color', 'almera'),					
				));
				?>				
			</div>

			<h4><?php _e('Recipient\'s e-mail field:', 'almera'); ?></h4>
				<?php
				TMM_OptionsHelper::draw_theme_option(array(
		...
		<ul class="drag_contact_form_list">
			...
			<li class="admin-drag-holder clearfix">
				...
				<h4><?php _e('Choose Field Type', 'almera'); ?></h4>
				<?php
				TMM_OptionsHelper::draw_theme_option(array(
				...
				<h4><?php _e('Field Label', 'almera'); ?></h4>
				<?php
				TMM_OptionsHelper::draw_theme_option(array(
				...
				<div class="select_options" style="display: none;">
					<h4><?php _e('Options (comma separated)', 'almera'); ?></h4>
					<?php
					TMM_OptionsHelper::draw_theme_option(array(
				...
				<h4><?php _e('Additional Options', 'almera'); ?></h4>
				<label class="with-check">
					...
					TMM_OptionsHelper::draw_theme_option(array(
						...
						'type' => 'checkbox',
						'default_value' => 0,
						'title' => __('Required Field', 'almera'),
						'description' => '',
