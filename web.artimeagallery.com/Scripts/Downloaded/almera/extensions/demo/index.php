...
<?php
//Thememakers programmer realmag777 dev
//*******
add_action('wp_head', array('TMM_Ext_Demo', 'wp_head'), 1);
		...
		<?php if (!empty($data)): ?>
			<?php foreach ($data as $key => $value) : ?>
				...
				<?php echo $key ?> : {
					...
					css_file_link : '<?php echo TMM_Helper::get_upload_folder_uri() . 'almera' . '/' . 'theme_schemes/' . strtolower($value['key']) . '.css' ?>',
                                        icon_type : 'color',
