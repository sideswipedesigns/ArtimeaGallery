    ...
    var THEMEMAKERS_AJAX = function() {
        ...
        scroll_box.on('mousedown', function(event) {
                            ...
                            if (jQuery('#folio_images_area').length) {
                                ...
                                jQuery('#folio_images_area a').each(function() {
                                    ...
                                    if ((this_menu_link != "#") && (this_menu_link != undefined)) {
                                        this_menu_link = this_menu_link.split('indexd41d.html?');
            ...
            add_content: function(response, dataId) {
                ...
                if (jQuery('.opacityEffect').length) {
                    jQuery('.section-full-width').effect({ effect: 'opacityEffect' });
                }

                if (jQuery('.scaleEffect').length) {
                    jQuery('.section-full-width').effect({ effect: 'scaleEffect' });
                }

                if (jQuery('.rotateEffect').length) {
                    jQuery('.section-full-width').effect({ effect: 'rotateEffect' });
                }

                if (jQuery('.slideRightEffect').length) {
                    jQuery('.section-full-width').effect({ effect: 'slideRightEffect' });
                }

                if (jQuery('.slideLeftEffect').length) {
                    jQuery('.section-full-width').effect({ effect: 'slideLeftEffect' });
                }

                if (jQuery('.slideDownEffect').length) {
                    jQuery('.section-full-width').effect({ effect: 'slideDownEffect' });
                }

                if (jQuery('.slideUpEffect').length) {
                    jQuery('.section-full-width').effect({ effect: 'slideUpEffect' });
                }

                if (jQuery('.projects').length) {
                    jQuery('.projects').effect({
                        effect : 'translateEffect',
                        speed: 200
                    });
                }
                ...
                if (jQuery('.thumbnails-items').length){
                    jQuery('.thumbnails-items').effect({
                        effect : 'translateEffect',
                        speed: 200
                    });
                }
                ...
                if (jQuery('.clients-items').length) {
                    jQuery('.clients-items').effect({
                        effect : 'translateEffect',
                        speed: 200,
                        beforeCall : function (el) {
                            jQuery(el).find('li').addClass(this.effect);
                        }
                    });
                }

                if (jQuery('.team-member.type-1').length) {
                    jQuery('.team-member.type-1').effect({
                        effect : 'scaleEffect',
                        speed: 200,
                        beforeCall : function (el) {
                            jQuery(el).find('article').addClass(this.effect);
                        }
                    });
                }

                if (jQuery('.ca-shortcode').length) {
                    jQuery('.section-full-width').effect({
                        effect: 'scaleEffect',
                        speed: 200,
                        beforeCall : function (el) {
                            jQuery(el).find('.ca-icon').addClass(this.effect);
                        }
                    })
                }

                // For ShortCode Image
                if (jQuery('.animate-image').length) {
                    jQuery('.container, .section-full-width').effect({
                        getData : false
                    });
                }
            ...
            epicslider: function() {
                ...
                if (jQuery('.epicSlider').length ? true : false) jQuery('body').addClass('full_'+jQuery('.epicSlider').data('template'));
                ...
                if(hideElements) {
                    document.onmousemove = function () {
                        ...
                        var test =true;
                        function mousestop() {
                            if (hide && jQuery('.epicSlider').length){
                                test = true;
                ...
                if(template=='alternate'){
                    jQuery('#wrapper').css('min-height',jQuery(window).outerHeight(true)- jQuery('#header').outerHeight(true)-48);
                }
            ...
            init_menu: function() {
                ...
                function ajaxLoad() {
                    ...
                    if ((jQuery(this).attr('data-load') != 'false') && (jQuery(this).attr('data-categories') == undefined)) {
                        ...
                        href = href.split('indexd41d.html?');
                        var url = site_url;
                        if (enable_hash == 'true') {
                            url = site_url + '/?' + href['1'];
                        }
